namespace Lab08.MVC.Data.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                {
                    ...
                    Header = c.String(nullable: false, maxLength: 80),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Advertisements", "CreatorUserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Advertisements", new[] { "CreatorUserId" });
